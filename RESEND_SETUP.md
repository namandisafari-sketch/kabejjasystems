...
1. Go to: https://app.supabase.com/project/ljgbjiixeoxxqpejnmjx/functions
2. Click **"Create a new function"**
3. Name it: `send-student-login-email`
...
2. Click **"Add Domain"**
3. Enter: `tennahubapps.com`
4. Follow the DNS verification steps (Resend will provide the records)
5. Once verified, you can send from: `noreply@tennahubapps.com`

---

## Step 3: Test the Email

After both are complete, run this command:

```bash
node test-resend-email.mjs
```

This will send a test branded email to `namandisafari@gmail.com`
...
1. **Supabase OTP Email** (plain text) - from Supabase's default email
2. **Resend Branded Email** (beautiful design) - from noreply@tennahubapps.com with:
   - TennaHub gradient header
   - Student name personalization
   - Professional "Secure Login" button
   - Security notices
   - Styled HTML

Check your spam folder if you don't see them in inbox.

...
interface StudentInfo {
  ...
  school_classes?: { name: string; level: string }[] | { name: string; level: string };
}
    ...
    try {
      ...
      if (isQueueMode) {
        ...
        const queuedStudent: QueuedStudent = {
          ...
          class_name: unwrapRelation(result.student.school_classes)?.name,
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-semibold">
                    {unwrapRelation(student.school_classes)?.name || "Not assigned"}
                  </p>
                </div>
                <div>
                ...
                <div className="border rounded-lg overflow-hidden shadow-lg">
                  <FeeReceiptThermal
                    ...
                    student={{
                      ...
                      class_name: unwrapRelation(student.school_classes)?.name,
                    }}

    ...
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-background">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <header className="h-14 border-b border-border flex items-center px-4 bg-card/95 backdrop-blur-sm sticky top-0 z-40 safe-top">
            <SidebarTrigger className="touch-target" />
            <span className="ml-3 font-medium text-sm truncate md:hidden">{businessName}</span>
          </header>

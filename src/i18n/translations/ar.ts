...
export const ar: TranslationKeys = {
  ...
  hr: {
    ...
    skills: "المهارات",
    previousEmployer: "صاحب العمل السابق",
    previousRole: "المنصب السابق",
    ...
    intern: "متدرب",
    fullTime: "دوام كامل",
    partTimeSchedule: "دوام جزئي",
    shiftBased: "عمل بالمناوبات",
    flexible: "مرن",
    remote: "عن بُعد",
    single: "أعزب",
    married: "متزوج",
    ...
    female: "أنثى",
    other: "آخر",
    enterSkill: "اكتب مهارة ثم اضف",
    addCertification: "إضافة شهادة",
    certificationName: "اسم الشهادة",
    step: "خطوة",
    of: "من",
    reviewInfo: "يرجى مراجعة جميع المعلومات قبل الإرسال",
    submitOnboarding: "إرسال وإكمال التسجيل",
    onboardingSuccess: "تم تسجيل الموظف بنجاح",
    onboardingComplete: "اكتمل التسجيل",
  },
};

                      ...
                      {parent.students.length === 0 ? (
                        ...
                        <div className="flex flex-wrap gap-1">
                          {parent.students.map((link) => {
                            const studentData = unwrapRelation(link.student);
                            const classData = studentData ? unwrapRelation(studentData.class) : null;
                            return (
                              ...
                              <Select value={selectedStudent} onValueChange={setSelectedStudent}>
                                ...
                                <SelectContent>
                                  {getAvailableStudents(parent).map((student) => {
                                    const classData = unwrapRelation(student.class);
                                    return (

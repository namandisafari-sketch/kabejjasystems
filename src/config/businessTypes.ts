...
export const businessTypes: BusinessTypeConfig[] = [
  ...
  { value: 'primary_school', label: 'Primary School', category: 'school', billingType: 'per_term', defaultModules: ['dashboard', 'students', 'classes', 'attendance', 'gate_checkin', 'visitor_register', 'grades', 'subjects', 'fees', 'discipline', 'employees', 'payroll', 'parents', 'timetable', 'exams', 'exam_sessions', 'exam_results_import', 'exam_import_permissions', 'exam_access', 'term_calendar', 'reports', 'settings'] },
  { value: 'secondary_school', label: 'Secondary School', category: 'school', billingType: 'per_term', defaultModules: ['dashboard', 'students', 'classes', 'attendance', 'gate_checkin', 'visitor_register', 'grades', 'subjects', 'fees', 'discipline', 'employees', 'payroll', 'parents', 'timetable', 'exams', 'exam_sessions', 'exam_results_import', 'exam_import_permissions', 'exam_access', 'term_calendar', 'uneb_registration', 'uneb_candidates', 'reports', 'settings'] },
